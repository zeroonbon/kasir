...
if (isset($_POST['submit'])) {
    ...
    $merk = $_POST['merk_barang']; // Mengambil merk barang dari input form
    ...
    $sql = "UPDATE barang SET nama_barang = '$nama', merk_barang = '$merk', harga_barang = '$harga', stok_barang = '$stok' WHERE id_barang = $id";
...
<body>
    ...
    <?php
        ...
        ?>
                ...
                <input type="text" id="merk_barang" name="merk_barang" value="<?php echo $data['merk_barang'] ?>" required><br><br>
